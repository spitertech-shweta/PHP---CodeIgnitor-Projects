...
class master_model extends CI_Model{
	...
	{
		$this->db->select('property_name,property_main_img,property_price');
    ...
    $result = $query->result();
	 ...
	 foreach($result as $sort_property_by_price)  {
		...
		<div class="col-lg-4 col-sm-6">
			...
			<div class="properties">'.$sort_property_by_price->property_name.'<div class="image-holder"><img src="'.base_url().$sort_property_by_price->property_main_img.'" class="img-responsive" alt="properties" id ="image_holder">';
