...
class Home extends CI_Controller
{
    ...
    public function home_page()
    {
        ...
        // $result['property'] = $this->master_model->show_data('property',$data1);
    ...
    //$where_property_type = array('property_type'=>$property_type);
    ...
    public function insert_contact()
    {
        ...
        $this->master_model->add_data('contact',$data);
