                                            ...
                                            <tbody><?php foreach($property as $property_listing){?>
                                             ...
                                             <tr>
											       <td><?php echo $property_listing->property_id; ?></td>
													...
													<td><?php echo $property_listing->property_kitchen; ?></td>
                                                    <td><?php echo $property_listing->property_bedroom; ?></td>
													<td><?php echo $property_listing->property_parking; ?></td>
													<td><?php echo $property_listing->property_living_room; ?></td>
