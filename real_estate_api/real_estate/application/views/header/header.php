...
<head>
  ...
  //$meta_tags = seo($controller_name, $method_name);

  ?>

  <meta name="description" content="<?php // print_r($meta_tags->meta_description);  ?>">
  <meta name="keywords" content="<?php  //print_r($meta_tags->meta_keyword); ?>">
...
<noscript>
    <link rel="stylesheet" type="text/css" href="<?php  echo base_url();?>assets/css/styleNoJS.css" />
</noscript>
<!-- slitslider -->
    ...
    <span class="glyphicon glyphicon-earphone"></span> (123) 456-7890      
          ...
          <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right">
                          ...
                          <li class ="active"><a href="<?php echo base_url()?>" id = "home" class="header">Home</a></li>
                          <li><a href="<?php echo base_url()?>about" id= "about" class="header">About</a></li>
                          <li><a href="<?php echo base_url()?>agents" id= "agents" class="header">Agents</a></li>       
                          <li><a href="<?php echo base_url()?>blog" id= "blog" class="header">Blog</a></li>
                          <li><a href="<?php echo base_url()?>contact" id= "contact" class="header">Contact</a></li>
                          <li><a href="<?php echo base_url()?>services" id= "services" class="header">Services</a></li>  
