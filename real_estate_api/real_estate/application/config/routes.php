...
$route['admin/show_property_enquiry'] = 'admin/Property/show_property_enquiry';  
$route['admin/show_contact_enquiry'] = 'admin/Property/show_contact_enquiry';  


//Seo controller
$route['admin/seo'] = 'admin/Seo/seo';  
$route['admin/add_seo'] = 'admin/Seo/add_seo';  
