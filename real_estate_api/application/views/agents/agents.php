...
<div class="row">
  ...
  <?php foreach($agent as $agent_listing) { ?>
      <!-- agents -->
      <div class="row">
        <div class="col-lg-2 col-sm-2"><a href="#"><img src="http://localhost/real_estate/<?php echo $agent_listing->agent_img; ?>" class="img-responsive"  alt="agent name" id = "agent_img"></a></div>
