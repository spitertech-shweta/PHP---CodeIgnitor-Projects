...
<head>
  ...
  <title>Morein Forget Password</title>
            ...
            <div class="card-body">
              ...
              <form method ="POST" action="<?php echo base_url();?>admin/forget_password">
                  <div class="form-group">
                    ...
                    <input type="email"  id="email" name="email" class="form-control" placeholder="Enter Email Id" required>                  </div>     
                    <h6 style = "color:red;"><?php echo $this->session->flashdata('Repeated Email ID'); ?></h6>
                 
                    <a href ="<?php echo base_url().'admin/forget_password_link'?>"><input name="forget_submit" id="forget_submit" class="btn btn-block login-btn mb-4" type="submit" value="SUBMIT"></a>
