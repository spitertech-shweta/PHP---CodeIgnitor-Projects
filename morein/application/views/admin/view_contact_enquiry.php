...
<div class ="col-md-3"></div>
	...
	<div class="row" style="padding-top: 7%; padding-left:30%; padding-right: 20%;">     
		...
		<div class="col-md-9">
            ...
            <a href="<?php echo base_url().'admin/show_contact_enquiry'?>"><button class="btn btn-primary">SHOW CONTACTS LISTING</button></a>
            <br><br>
        ...
        <div class="col-md-9">
			<div class="form-group">
                <input type="text" class="form-control" id="contact_mobile" name="contact_mobile"  value="<?php echo $view_contact_enquiry->contact_mobile; ?>" readonly>
             </div>
		</div>
        ...
        <div class="col-md-9">
			<div class="form-group">
                <input type="text" class="form-control" id="contact_address" name="contact_address"  value="<?php echo $view_contact_enquiry->contact_address; ?>" readonly>
             </div>
		</div>

        <div class="col-md-9">
			<div class="form-group">
                <input type="text" class="form-control" id="contact_message" name="contact_message"  value="<?php echo $view_contact_enquiry->contact_msg; ?>" readonly>
             </div>
		</div>
