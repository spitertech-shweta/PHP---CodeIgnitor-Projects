     ...
     <div class ="col-md-3"></div>
       ...
       <div class="row" style="padding-top: 7%; padding-left: 30%; padding-right: 10%;">     
           ...
           <div class="col-md-9">
              ...
              <label>Blog Image</label>
               <span class="btn btn-success fileinput-button" style="display:block; background-color:teal; width:250px;height:60px;">
                <span><input type="file" name="blog_img" id="blog_img" class="file-upload-default"multiple accept="image/jpeg, image/png, image/gif"><br />
                   </span>
               </span>
           ...
           <div class="col-md-9">
               ...
               <h5 style ="width:600px"><label>Blog Title</label><input type="text" class="form-control" id="blog_title" name="blog_title" placeholder="Blog title"></h5>
               </div>
           </div>
           <div class="col-md-9">
                   <div class="form-group">
                   <h5 style ="width:600px;"><label>Blog Description</label><textarea name="blog_desc"></textarea></h5>
             </div>
           </div>	
             ...
             <div class="col-md-9">
               <div class="form-group">		 
                  ...
                  <a href="<?php echo base_url().'admin/show_blog/'?>"> <button type="button" class="btn btn-primary">CANCEL</button></a>
                </div>
              </div>
