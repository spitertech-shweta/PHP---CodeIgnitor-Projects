...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Morein - Admin</title>
        <meta name="description" content="">
        <meta name="keywords" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        
        <link rel="icon" href="favicon.ico" type="image/x-icon" />
        <link rel="stylesheet" href="<?php echo base_url()?>custom_assets/custom_css.css" />
                ...
                <div class="app-sidebar colored">
                    <div class="sidebar-header">
                        <a class="header-brand" href="<?php echo base_url();?>">
						    ...
						    <div>
                            <span class="text"><?php echo $this->session->userdata('user_full_name');
                            ?></span>
                            </div>
                        ...
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item active">
                                    <a href="<?php echo base_url();?>admin/edit_user"><i class="ik ik-bar-chart-2"></i><span>USERS</span></a>
                                </div>

                                <div class="nav-item active">
                                    <a href="<?php echo base_url();?>admin/show_user_designation"><i class="ik ik-bar-chart-2"></i><span>USER DESIGNATION</span></a>
                                </div>

                                <div class="nav-item active">
                                    <a href="<?php echo base_url();?>admin/show_client"><i class="ik ik-bar-chart-2"></i><span>USER CLIENTS</span></a>
                                </div>

                                <div class="nav-item active">
                                    <a href="<?php echo base_url();?>admin/show_work"><i class="ik ik-bar-chart-2"></i><span>WORK</span></a>
                                </div>

                                <div class="nav-item active">
                                    <a href="<?php echo base_url();?>admin/show_service"><i class="ik ik-bar-chart-2"></i><span>SERVICE</span></a>
                                </div>
                                ...
                                <div class="nav-item active">
                                    <a href="<?php echo base_url();?>admin/show_testimonial"><i class="ik ik-bar-chart-2"></i><span>CLIENT TESTIMONIAL</span></a>
                                </div>

                                <div class="nav-item active">
                                    <a href="<?php echo base_url();?>admin/edit_social_sharing"><i class="ik ik-bar-chart-2"></i><span>SOCIAL SHARING</span></a>
                                </div>

                                <div class="nav-item active">
                                    <a href="<?php echo base_url();?>admin/show_contact_enquiry"><i class="ik ik-bar-chart-2"></i><span>CONTACT</span></a>
                                </div>
                  
                                <div class="nav-item active">
									<a href="<?php echo base_url().'admin/log_out/'?>"><i class="ik ik-bar-chart-2"></i><span>LOG OUT</span></a>
								</div>
                            </nav>
                        </div>
                    </div>
