            ...
            <div class="form-group">
                ...
                <tr>
                    <td><span class="btn btn-success fileinput-button" style="display:block; background-color:teal; width:250px;height:60px;">
                     <span>Icon Image</span><input type="file" name="blog_img" id="blog_img"/></td><td>&nbsp;&nbsp;</td>
                    <td><span>Old Image</span><img src = "<?php echo base_url().$edit_blog->blog_img;?>" width = "100" height = "100"/></td> 
      ...
      <div class="col-md-9">
        ...
        <div class="col-md-9">
          ...
          <label>Blog Owner</label>
                  <input type="text" class="form-control" id="blog_owner" name="blog_owner"  value="<?php echo $edit_blog->blog_owner; ?>">
          </div>
		  </div>
